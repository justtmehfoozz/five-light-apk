...
with open('./app/src/main/java/com/example/ui/components/KhatmPlannerSheet.kt', 'r') as f:
    content = f.read()
...
with open('./app/src/main/java/com/example/ui/components/KhatmPlannerSheet.kt', 'w') as f:
    f.write(content)
